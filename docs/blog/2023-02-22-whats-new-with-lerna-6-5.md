...
tags: [nx, release]
description: A comprehensive overview of Lerna 6.5's new features, including idempotent publishing, multi-script execution, private package handling, and major codebase improvements, along with updates on Lerna's development since being maintained by the Nx team.
---
