...
pinned: true
description: A case study of how a major US sports retailer improved their monorepo architecture with Nx, reducing CI pipeline times from an hour to 7-9 minutes and increasing cache hit rates from 20% to 57%.
---
