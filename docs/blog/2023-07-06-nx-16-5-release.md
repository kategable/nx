...
tags: [nx, release]
description: Announcing Nx 16.5 with major features including tag-based task targeting, NextJS 13 support with React Server Components, new Nx recipes, Angular 16 compatibility, Verdaccio integration, custom CLI creation capabilities, external dependencies input type, dependency checks ESLint rule, and significant performance improvements through Rust integration.
---
