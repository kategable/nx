...
description: A live coding session where Zack introduces Mike Hartington to Nx by building a full-stack application, demonstrating Nx's generators, workspace configuration, and CI capabilities.
---
