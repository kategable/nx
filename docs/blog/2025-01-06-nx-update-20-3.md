...
description: A comprehensive overview of the latest features and improvements in Nx 20.3, including TypeScript project references, Rspack updates, new Nx Console features, and various enhancements to Nx Cloud.
---
