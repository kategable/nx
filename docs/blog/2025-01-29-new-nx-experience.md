...
description: Introducing a new Nx setup that combines package manager workspaces with TypeScript project references to improve performance, memory usage, and editor support in large monorepos.
---
