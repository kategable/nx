...
description: An update on Nx's growth from a consulting side project to a tool empowering millions of developers, discussing the evolution of Nx Cloud and the introduction of Nx Powerpack to extend Nx's capabilities.
---
