...
tags: [nx, release]
description: Nx 19 marks a return to the regular six-month release schedule following Nx 18's Project Crystal, which revolutionized Nx plugins by making them work automatically with minimal configuration.
---
