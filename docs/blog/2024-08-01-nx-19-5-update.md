...
tags: [nx, release]
description: Nx 19.5 introduces StackBlitz support, Bun and Pnpm v9 compatibility, local flaky task detection, and enhanced project detail views, along with improvements to target configuration and parallelism controls.
---
