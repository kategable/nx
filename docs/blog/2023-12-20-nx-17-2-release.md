...
description: Announcing Nx 17.2 with major improvements including simplified project configuration, Rust-powered task hashing, enhanced Module Federation support, expanded release capabilities, Angular 17 compatibility, and the introduction of Nx Agents for faster CI performance.
---
