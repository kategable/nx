...
description: Introducing the new nx import command that allows you to seamlessly import external repositories and projects into your Nx monorepo while preserving git history and enabling selective imports.
---
