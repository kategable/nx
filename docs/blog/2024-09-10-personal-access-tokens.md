...
description: Introducing Personal Access Tokens in Nx Cloud, a major security upgrade that provides enhanced control over cached artifacts access, replacing the previous system of workspace-wide access tokens.
---
