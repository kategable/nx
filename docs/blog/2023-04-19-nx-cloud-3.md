...
tags: [nx, nx-cloud]
description: Announcing Nx Cloud 3.0 with major improvements including streamlined UI design, faster cache management through prefetching and background uploads, enhanced Distributed Task Execution (DTE), direct VCS integrations, enterprise features like Helm charts and SSO, and a simplified pricing model based on CI pipeline executions.
---
