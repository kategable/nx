...
tags: [nx, release]
description: Announcing Nx 15.7 with major improvements including first-class Node.js support for Express, Fastify and Koa, detached Angular version support for LTS versions, standalone API bootstrapping, enhanced lockfile parsing and pruning, Storybook 7.0 beta support, and more flexible Webpack configuration.
---
