...
tags: [nx, release]
description: Announcing Nx 17 with major features including first-class Vue.js support, enhanced Module Federation capabilities, improved generator paths, AI chatbot integration, seamless Nx Cloud integration, simplified nx.json configuration, Nx Workflows for CI, task graphing improvements, and experimental features like Nx Release and Project Inference API v2.
---
