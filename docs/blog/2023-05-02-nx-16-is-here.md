...
tags: [nx, release]
description: Announcing Nx 16 with major updates including package rescoping from @nrwl to @nx, enhanced Deno support with standalone apps and edge deployment capabilities, Cypress feature testing improvements, task graph visualization tools, and migration to PNPM for improved performance.
---
