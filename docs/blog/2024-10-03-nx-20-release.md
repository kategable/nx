...
description: Nx 20 release brings quality improvements to the monorepo experience and TypeScript performance, building on Nx 19's features like nx import, inferred tasks, rspack bundling, file-based versioning, and Gradle support.
---
