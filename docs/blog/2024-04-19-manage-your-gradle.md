...
description: A guide to managing Gradle projects in Nx workspaces, demonstrating how to visualize library relationships and efficiently manage multi-tech stack monorepos using the new @nx/gradle plugin.
---
