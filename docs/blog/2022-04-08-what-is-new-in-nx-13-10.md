...
tags: [nx, release]
description: Announcing Nx 13.10 with major improvements including core package consolidation, Nx Daemon enabled by default, local plugin development support, enhanced project graph visualization, new module boundary lint rules, React 18 and React Native Storybook support, and improved Nx Console features.
---
