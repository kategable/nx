...
description: Announcing the new @nx/playwright plugin, with a comprehensive guide on how to set up and use Playwright for end-to-end testing in both new and existing Nx workspaces.
---
