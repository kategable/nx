...
tags: [nx]
description: Introducing the integration of Nx Cloud features directly into Nx Console 17.28.0, bringing remote caching, distributed task execution, and VCS integration right into VSCode, with a streamlined setup process and improved workspace management capabilities.
---
