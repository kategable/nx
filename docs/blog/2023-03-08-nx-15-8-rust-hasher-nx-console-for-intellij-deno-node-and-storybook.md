...
tags: [nx, release]
description: Announcing Nx 15.8 with major performance improvements through a new Rust-based hasher, official IntelliJ IDE support via Nx Console, experimental Deno integration, enhanced Node.js application modularization, Storybook CSF3 support, and improved developer experience with field prioritization features.
---
